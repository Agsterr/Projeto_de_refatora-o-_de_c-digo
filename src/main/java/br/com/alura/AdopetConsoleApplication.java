...
public class AdopetConsoleApplication {
    ...
    private static void listarAbrigos() throws IOException, InterruptedException {
      ...
      HttpResponse<String> response =
        dispararRequisicaoGet(client,uri);
    ...
    private static void cadastrarAbrigos() throws IOException, InterruptedException {
        ...
        HttpResponse response =
                dispararRequisicaoPost(uri,json,client);
    ...
    private static HttpResponse<String> dispararRequisicaoPost(String uri, JsonObject json, HttpClient client) throws IOException, InterruptedException {
